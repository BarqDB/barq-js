For sake of consistency, here are some general principles to follow when writing [TSDoc](https://tsdoc.org/) for Barq classes' properties and methods.

### Methods:
Here are all the tags Barq class methods are likely to have, **listed in the order that they should be described in**.
- **ALL TAGS**
...
- `@throws {@link errorType} {If / When + description}`
    ...
    - ✅ `@throws {@link RuntimeError} When Barq closes.`
