...
import { BoundSpec, Class, Enum, Method, NamedType, Property, Struct, Type } from "@barq/bindgen/bound-model";
...
export function generate({ spec: boundSpec, rawSpec, file }: TemplateContext): void {
  ...
  out.lines(
    'import { ObjectId, UUID, Decimal128, EJSON } from "../types";',
    'import { Long } from "./Int64";',
