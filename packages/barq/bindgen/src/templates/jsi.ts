...
import { TemplateContext } from "@barq/bindgen/context";
import { CppVar, CppFunc, CppFuncProps, CppCtor, CppMethod, CppClass, CppDecls, CppMemInit } from "@barq/bindgen/cpp";
import {
  BoundSpec,
  Class,
  InstanceMethod,
...
declare module "@barq/bindgen/bound-model" {
  interface Struct {
    toJsi: () => CppFunc;
    fromJsi: () => CppFunc;
  }
