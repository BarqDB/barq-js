...
import { type SubscriptionOptions, WaitForSync } from "./sync/MutableSubscriptionSet";
 ...
 * added to or deleted from the Barq that match the underlying query. Results returned by
...
> {
  ...
  /**
   * Checks if this results collection has not been deleted and is part of a valid Barq.
