...
import type { ClientResetMode } from "./sync/SyncConfiguration";
 ...
 * @see https://github.com/BarqDB/barq-js/blob/main/CHANGELOG.md#1110-2022-11-01
 * @see https://github.com/BarqDB/barq-js/issues/4135
 */
