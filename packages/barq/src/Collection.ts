...
/**
 * Abstract base class containing methods shared by Barq {@link List}, {@link Dictionary}, {@link Results} and {@link BarqSet}.
 *
 * A {@link Collection} always reflect the current state of the Barq. The one exception to this is
...
> implements Iterable<T>
{
  ...
  /**
   * Checks if this collection has not been deleted and is part of a valid Barq.
