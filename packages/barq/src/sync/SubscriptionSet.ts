...
/**
 * Represents the set of all active flexible sync subscriptions for a Barq instance.
 *
...
export class SubscriptionSet extends BaseSubscriptionSet {
   ...
   *  from the set, and the {@link Barq} associated with the SubscriptionSet as the
