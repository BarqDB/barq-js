 ...
 * Unlike JavaScript's Set, Barq~Set does NOT make any guarantees about the
...
> {
  ...
  /**
   * Checks if this Set has not been deleted and is part of a valid Barq.
...
export type AnySet = BarqSet<any>;

injectIndirect("Set", BarqSet);
