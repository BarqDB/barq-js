...
/**
 * Implements https://github.com/BarqDB/barq-js/blob/v11/src/js_schema.hpp#L433-L478
 * @internal
 */
...
/**
 * Implements https://github.com/BarqDB/barq-js/blob/v11/src/js_schema.hpp#L480-L530
 * @internal
 */
...
/** @internal */
export function fromBindingBarqSchema(schema: Readonly<BindingObjectSchema[]>): CanonicalObjectSchema[] {
