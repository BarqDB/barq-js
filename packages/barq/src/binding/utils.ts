...
export function _throwOnAccess(propertyName: string) {
  throw new Error(`Accessed property '${propertyName} before the native module was injected into the Barq binding'`);
}
...
export const ListSentinel = Symbol.for("Barq.List");
export const DictionarySentinel = Symbol.for("Barq.Dictionary");
