...
Pod::Spec.new do |s|
  ...
  s.source                 = { :http => 'https://github.com/BarqDB/barq-js/blob/main/CONTRIBUTING.md#how-to-debug-react-native-podspec' }
  ...
  s.source_files           = 'binding/jsi/*.cpp',
                             ...
                             'binding/jsi/*.hpp',
                             'bindgen/src/*.h',
                             'bindgen/vendor/barq-core/bindgen/src/*.h'

  s.public_header_files    = 'binding/apple/*.h'

  s.resource_bundles       = { 'BarqJS' => ['PrivacyInfo.xcprivacy'] }
  ...
  s.pod_target_xcconfig    = {
                                ...
                                'HEADER_SEARCH_PATHS' => [
                                  ...
                                  '"${PODS_TARGET_SRCROOT}/bindgen/vendor/barq-core/bindgen/src/"',
                                ]
                              }

  s.vendored_frameworks = 'prebuilds/apple/barq-core.xcframework'
