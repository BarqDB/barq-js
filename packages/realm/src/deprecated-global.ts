...
import { Barq as BarqConstructor } from "./Barq";
...
Object.defineProperty(safeGlobalThis, "Barq", {
  get() {
    ...
    return BarqConstructor;
  },
  configurable: true,
});

declare global {
  // No need to keep this updated with the namespace in Barq.ts, since this is marked as deprecated
  // We cannot simply "export import Barq" here, because that results in ts(2667):
  // "Imports are not permitted in module augmentations. Consider moving them to the enclosing external module."

  /* eslint-disable @typescript-eslint/no-namespace */

  /** @deprecated Will be removed in v13.0.0. Please use an import statement. */
  export class Barq extends BarqConstructor {}
  /**
   * @deprecated Will be removed in v13.0.0. Please use an import statement.
   */
  export namespace Barq {
    export import Barq = BarqConstructor;
