...
const TYPE_NAME_VARIANTS: Record<string, string[]> = {
  ...
  decimal128: ["Barq.Types.Decimal128", "Types.Decimal128", "Barq.Types.Decimal128", "BSON.Decimal128"],
  objectId: ["Barq.Types.ObjectId", "Types.ObjectId", "Barq.Types.ObjectId", "BSON.ObjectId"],
  uuid: ["Barq.Types.UUID", "Types.UUID", "Barq.Types.UUID", "BSON.UUID"],
