...
const TYPE_NAME_VARIANTS: Record<string, string[]> = {
  bool: ["boolean", "Barq.Types.Bool", "Types.Bool"],
  string: ["string", "Barq.Types.String", "Types.String"],
  int: ["Barq.Types.Int", "Types.Int"],
  float: ["Barq.Types.Float", "Types.Float"],
  double: ["number", "Barq.Types.Double", "Types.Double"],
  decimal128: ["Barq.Types.Decimal128", "Types.Decimal128", "Barq.Types.Decimal128", "Types.Decimal128"],
  objectId: ["Barq.Types.ObjectId", "Types.ObjectId", "Barq.Types.ObjectId", "Types.ObjectId"],
  uuid: ["Barq.Types.UUID", "Types.UUID", "Barq.Types.UUID", "Types.UUID"],
  date: ["Date", "Types.Date", "Barq.Types.Date"],
  data: ["ArrayBuffer", "Types.Data", "Barq.Types.Data"],
  list: ["Barq.List", "Barq.Types.List", "Types.List", "List"],
  set: ["Barq.Set", "Barq.Types.Set", "Types.Set", "Set"],
  dictionary: ["Barq.Dictionary", "Barq.Types.Dictionary", "Types.Dictionary", "Dictionary"],
  mixed: ["Barq.Types.Mixed", "Types.Mixed", "Barq.Mixed", "Mixed"],
};
