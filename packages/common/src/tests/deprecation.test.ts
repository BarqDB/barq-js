  ...
  describe("handleDeprecatedPositionalArgs", () => {
    ...
    describe("without restArgs", () => {
      ...
      it("converts a single positional argument into an object and shows a deprecation warning", () => {
        ...
        expect(consoleOutput[0]).to.equal(
          "Deprecation warning from Barq: test(testArg) is deprecated and will be removed in a future major release. Consider switching to test({ testArg }).",
        );
      });
      ...
      it("converts multiple positional arguments into an object and shows a deprecation warning", () => {
        ...
        expect(consoleOutput).to.have.length(1);
        expect(consoleOutput[0]).to.equal(
          "Deprecation warning from Barq: test(testArg1, testArg2, testArg3) is deprecated and will be removed in a future major release. Consider switching to test({ testArg1, testArg2, testArg3 }).",
        );
      });
    });
    ...
    describe("with restArgs", () => {
      ...
      it("converts a single positional argument into an object, passes through restArgs, and shows a deprecation warning", () => {
        ...
        expect(consoleOutput).to.have.length(1);
        expect(consoleOutput[0]).to.equal(
          "Deprecation warning from Barq: test(testArg, ...args) is deprecated and will be removed in a future major release. Consider switching to test({ testArg }, ...args).",
        );
      });
      ...
      it("converts multiple positional arguments into an object passes through restArgs, and shows a deprecation warning", () => {
        ...
        expect(consoleOutput).to.have.length(1);
        expect(consoleOutput[0]).to.equal(
          "Deprecation warning from Barq: test(testArg1, testArg2, testArg3, ...args) is deprecated and will be removed in a future major release. Consider switching to test({ testArg1, testArg2, testArg3 }, ...args).",
        );
      });
    });
  });
