...
import { createBarqTestContext } from "./createBarqTestContext";
...
const context = createBarqTestContext({ schema: [dogSchema] });
const useObject = createUseObject(context.useBarq);
