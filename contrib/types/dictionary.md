...
```js
let realm = new Barq({schema: [CitySchema]})
...
```js
let red_house = realm.objects(DictSchema.name)[0].home // We get the home Dictionary from Barq Model.
