...
<!--ts-->
- [Building Barq JS](#building-barq-js)
  ...
  - [Cloning the repository](#cloning-the-repository)
    ...
    - [Visual Studio Code setup](#visual-studio-code-setup)
      ...
      - [C++](#c)
  - [Building Barq JS](#building-barq-js-1)
...
To clone the Barq JS repository and install git submodules, dependencies, and subpackage dependencies, run:
...
On Windows the Barq JS repo should be cloned with symlinks enabled:

```cmd
# run in elevated command prompt
git clone -c core.symlinks=true https://github.com/BarqDB/barq-js
```
...
```cmd
# run in elevated command prompt
cd barq-js\react-native\android\src\main\jni
# remove src and vendor files
del src
del vendor
mklink /j "src" "../../../../../src/"
mklink /j "vendor" "../../../../../vendor"
cd barq-js\tests\ReactTestApp\android\app\src\main
# remove assets file
del assets
...
Visual Studio Code is the recommended editor for the best experience working with the Barq JS codebase.
...
1. Open the `barq-js` root directory in VS Code and open any TypeScript file
...
You can build Barq JS for ARM/Linux from source and include it in your own project.
...
We use a `.clang-format` file based on the one from `barq-core`, but feel free to modify if required.
...
Here's the suggested workflow for testing your changes to Barq JS against real apps:
